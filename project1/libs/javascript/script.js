    ...
    l.on('click', function(e) {
        $.ajax({
            ...
            success: function(result) {
                ...
                clusterMarkers.clearLayers(); //clear map of previous layers
                var points = markersGroup._layers; //setting points as all currently generated points
                var searchWithin = f; //search within the current feature/multi-polygon
                var ptsWithin = turf.pointsWithinPolygon(points, searchWithin); //checks if points are within the feature/multi-polygon
                var markersOnFeature = L.layerGroup(ptsWithin); //create new layerGroup consisting of the new featureCollection generated by turf
                console.log(markersGroup);
                console.log(searchWithin);
                console.log(ptsWithin);
                console.log(markersOnFeature);
                ...
                markersOnFeature.addTo(clusterMarkers); //
...
function processPortJSON(data) {
    ...
    portMarkers.addTo(markersGroup);
}
...
function processAirportJSON(data) {
    ...
    airportMarkers.addTo(markersGroup);
};
...
function processCitiesJSON(data) {
    ...
    citiesMarkers.addTo(markersGroup);
};

/* var loadMarkersForCountry = function() {
    var points = clusterMarkers;
    var searchWithin = geoJSONLayer;
